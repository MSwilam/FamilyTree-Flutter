...
class UpdateFamilyNickName extends StatelessWidget {
  UpdateFamilyNickName({Key? key, required this.familyNickName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    generalGrandparentsProvider.familyNickName = familyNickName;
    final _formKey = GlobalKey<FormState>();
    return Scaffold(
        backgroundColor: screenColor,
        appBar: AppBar(
          title: Text(('update_familyNickName').tr()),
          leading: IconButton(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    TextFormField(
                      ...
                      initialValue: familyNickName.arabicName,
                      onChanged: (val) {
                    ...
                    TextFormField(
                      ...
                      initialValue: familyNickName.englishName,
                      onChanged: (val) {
